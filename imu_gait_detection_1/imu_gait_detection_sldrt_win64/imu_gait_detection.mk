...
MODEL                := imu_gait_detection
MODULES              := can_datatype_ground.c imu_gait_detection_data.c imu_gait_detection_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := imu_gait_detection.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := imu_gait_detection_ref.rsp
...
# additional includes
REQ_INCLUDES += ;G:/NutStoreSync/FFTAI/FFTAI-UofMELB/Robot-Matlab-Simulink/imu_gait_detection_1;G:/NutStoreSync/FFTAI/FFTAI-UofMELB/Robot-Matlab-Simulink/imu_gait_detection_1/imu_gait_detection_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src;$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil
